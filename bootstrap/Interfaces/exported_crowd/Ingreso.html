...
<body style="background:linear-gradient(rgba(47, 23, 15, 0.65), rgba(47, 23, 15, 0.65)), url('assets/img/bg.jpg?h=1a9398b8c353a8cdf63d59f5136160b1');">
    <h1 class="text-center text-white d-none d-lg-block site-heading"><span class="text-primary site-heading-upper mb-3">A Free Bootstrap 4 Business Theme&nbsp;</span></h1>
    ...
    <section class="page-section about-heading">
        <div class="container"><img class="img-fluid rounded about-heading-img mb-3 mb-lg-0" src="assets/img/header-bg.jpg?h=b8466c0919756b37f84bf6f4883412b5">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <div class="col-lg-12">
                                        <form id="contactForm" name="contactForm" novalidate="novalidate">
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="clearfix"></div><label class="d-lg-flex align-items-center align-content-center m-auto align-items-lg-center" style="font-size: 40;"><strong>Email:</strong></label><label class="d-lg-flex align-items-center align-content-center m-auto justify-content-lg-start"
                                                        style="font-size: 40;"><strong>Password:</strong></label></div>
                                                <div class="col col-md-6">
                                                    ...
                                                    <div class="form-group"><input class="form-control" type="password" placeholder="Your Password *" required=""><small class="form-text text-danger help-block lead"></small></div>
                                                </div>
                                                <div class="col-lg-12 text-center">
                                                    <div id="success"></div><button class="btn btn-primary btn-xl text-uppercase" id="sendMessageButton" type="submit">Ingresar</button></div>
                                            </div>
                                        </form>
                                    </div>
                                </div>
