...
<body style="background:linear-gradient(rgba(47, 23, 15, 0.65), rgba(47, 23, 15, 0.65)), url('/assets/img/bg.jpg?h=1a9398b8c353a8cdf63d59f5136160b1');">
                ...
                <div class="row">
                    <div class="col-lg-10 col-xl-9 offset-sm-7 mx-auto">
                        <div class="bg-faded rounded p-5">
                            <h2 class="section-heading mb-4"><span class="text-center section-heading-lower">&nbsp;Datos de tarjeta</span></h2>
                                            ...
                                            <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <input class="form-control" type="number" id="cardnumber" placeholder="Número de tarjeta: 123456789 *" required="">
                                                            <input class="form-control" type="number" id="cardmonth" placeholder="Mes: MM *" required="">
                                                            <input class="form-control" type="number" id="cardyear" placeholder="Año: AA *" required="">
                                                            <input class="form-control" type="number" id="cardcvc" placeholder="CVC: 123 *" required="">
                                                            <input class="form-control" type="number" id="price" placeholder="Valor de aporte: $1 *" required="">
                                                        </div>
                                                        <button class="btn btn-primary btn-xl text-uppercase" id="sendMessageButton" onClick="submitCard()" type="button">COLABORAR</button>
                                                    </div>
                                                </div>
                                        </div>
                                    </form>
    ...
    <script>
        function submitCard(){
            ...
            if(data.cardnumber!=="" && data.cardmonth!=="" && data.cardyear!=="" && data.cardcvc!=="" && data.price!==""){
                $("#spinnerModal").modal('show');
                $.post({
                    type: "POST",
                    url: "http://localhost:8000/api/makepayment",
                    data: data
                }, function(response){
